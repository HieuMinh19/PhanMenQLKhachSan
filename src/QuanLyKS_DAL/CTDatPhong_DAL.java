...
public class CTDatPhong_DAL {
	public static boolean Insert(CTDatPhong_DTO ctDP){
		...
		String query = "INSERT INTO CTDATPHONG(TenKH, CMND, MaDichVu, MaPhong, NgayNhan, NgayTra) VALUES (?, ?, ?, ?, ?, ?)";
		...
		try {
			...
			ptmt.setInt(3, ctDP.getMaDichVu());
			ptmt.setInt(4, ctDP.getMaPhong());
			ptmt.setString(5, ctDP.getNgayNhan());
			ptmt.setString(6, ctDP.getNgayTra());
